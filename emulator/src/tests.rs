...
#[test]
#[timeout(5000)]
fn pmpsm_pmpcfg_walk_5_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_pmpcfg_walk-5.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmps_tor_legal_lxwr_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmps_tor_legal_lxwr-01.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_05_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-05.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn S_scsr_02_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/S_scsr-02.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_cfg_na4_all_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_cfg_na4_all.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn U_ucsr_02_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/U_ucsr-02.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_09_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-09.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_02_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-02.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn U_ucsr_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/U_ucsr-01.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_tor_legal_lwxr_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_tor_legal_lwxr-01.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn S_scsr_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/S_scsr-01.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Sm_csr_ro_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_csr_ro-01.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmps_cfg_XWR_unlocked_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmps_cfg_XWR_unlocked.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn U_ucsr_ro_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/U_ucsr_ro-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmps_tor_legal_lxwr_02_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmps_tor_legal_lxwr-02.elf", 0);
    let ret = interpreter.run();
...
fn ExceptionsSm_medeleg_s_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/ExceptionsSm_medeleg_s-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_pmpcfg_walk_4_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_pmpcfg_walk-4.elf", 0);
    let ret = interpreter.run();
...
fn ExceptionsSm_medeleg_u_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/ExceptionsSm_medeleg_u-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_pmpcfg_walk_6_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_pmpcfg_walk-6.elf", 0);
    let ret = interpreter.run();
...
fn Zmmul_mulhu_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Zmmul-mulhu-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_pmpcfg_walk_1_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_pmpcfg_walk-1.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn U_ucsr_05_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/U_ucsr-05.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpu_na4_legal_lxwr_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpu_na4_legal_lxwr.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Sm_shadow_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_shadow-00.elf", 0);
    let ret = interpreter.run();
...
fn Zmmul_mulhsu_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Zmmul-mulhsu-00.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_11_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-11.elf", 0);
    let ret = interpreter.run();
...
fn S_scsr_insufficient_priv_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/S_scsr_insufficient_priv-00.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Sm_inst_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_inst-00.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Sm_xret_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_xret-00.elf", 0);
    let ret = interpreter.run();
...
fn Sm_scsr_from_m_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_scsr_from_m-00.elf", 0);
    let ret = interpreter.run();
...
fn Zmmul_mulh_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Zmmul-mulh-00.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_cntr_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_cntr-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpu_tor_legal_lxwr_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpu_tor_legal_lxwr-01.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_04_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-04.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_03_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-03.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn U_ucsr_04_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/U_ucsr-04.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmps_na4_legal_lxwr_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmps_na4_legal_lxwr.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_07_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-07.elf", 0);
    let ret = interpreter.run();
...
fn Sm_csr_insufficient_priv_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_csr_insufficient_priv-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpzca_misaligned_na4_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpzca_misaligned_na4.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpzca_aligned_na4_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpzca_aligned_na4.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Sm_misa_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_misa-00.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn S_scsr_ro_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/S_scsr_ro-00.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Sm_mcause_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcause-00.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn U_ucsr_03_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/U_ucsr-03.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mstatus_sd_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mstatus_sd-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpu_tor_legal_lxwr_02_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpu_tor_legal_lxwr-02.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_06_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-06.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn S_scsr_ro_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/S_scsr_ro-01.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_access_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_access-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_pmpcfg_walk_3_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_pmpcfg_walk-3.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpzca_cret_na4_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpzca_cret_na4.elf", 0);
    let ret = interpreter.run();
...
fn ExceptionsSm_medeleg_m_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/ExceptionsSm_medeleg_m-00.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_08_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-08.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Sm_csr_ro_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_csr_ro-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpu_cfg_XWR_unlocked_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpu_cfg_XWR_unlocked.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn S_scsr_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/S_scsr-00.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_pmpcfg_walk_2_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_pmpcfg_walk-2.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_10_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-10.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_tor_legal_lwxr_02_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_tor_legal_lwxr-02.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn pmpsm_na4_legal_lwxr_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/pmpsm_na4_legal_lwxr.elf", 0);
    let ret = interpreter.run();
...
#[test]
#[timeout(5000)]
fn InterruptsSSm_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/InterruptsSSm-00.elf", 0);
    let ret = interpreter.run();
...
fn S_scsr_insufficient_priv_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/S_scsr_insufficient_priv-01.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn Zmmul_mul_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Zmmul-mul-00.elf", 0);
    let ret = interpreter.run();
...
fn Sm_mcsr_walk_01_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/Sm_mcsr_walk-01.elf", 0);
    let ret = interpreter.run();
...
#[timeout(5000)]
fn U_ucsr_00_elf() {
    let mut interpreter = Interpreter::new_test_elf("../semihosting_elf_tests/U_ucsr-00.elf", 0);
    let ret = interpreter.run();
